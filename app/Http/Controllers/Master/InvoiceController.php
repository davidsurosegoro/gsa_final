...
class InvoiceController extends Controller
{
    ...
    {    
        ...
        $invoice->total_koli           = ($request->total_koli)             ? $request->total_koli          : 0; 
        $invoice->total_kg             = ($request->total_kg)               ? $request->total_kg            : 0; 
        $invoice->total_doc            = ($request->total_doc)              ? $request->total_doc           : 0; 
