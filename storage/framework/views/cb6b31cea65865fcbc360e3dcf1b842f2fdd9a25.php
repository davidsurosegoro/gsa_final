<?php if(!Browser::isChrome() ): ?> 
    ...
    border-color: #ffeeba;margin-top:10px;position: absolute;bottom:0px; z-index:2000;">
        <img src="<?php echo e(asset('assets/gsa/img/chrome.png')); ?>" class="col- " style="object-fit: contain; width:50px; ">
        <div class="col-11">
...
</div><?php /**PATH C:\xampp\htdocs\GSA\gsa_final\resources\views/camera.blade.php ENDPATH**/ ?>