...
<div class="card-header">
    <h3 class="card-title">SCANNER MANIFEST <br>ke status -> <?php echo e(Crypt::decrypt($status)); ?> </h3>
</div> 
<input type='hidden' id='statusmanifest' value='<?php echo e($status); ?>' > 
<div class=" ">
    <div class="container">
        <div class="row">
            <audio id="myAudio">
...
<?php $__env->stopSection(); ?> 
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\GSA\gsa_final\resources\views/pages/scanner/qrmanifest.blade.php ENDPATH**/ ?>