  ...
  $(document).ready(function() {
    ...
    $("#btnproses").on('click',function(){
        if($("#txtPeriod").val() != ''){
            $.ajax({
                type : "POST",
                url : "<?php echo e(url('report/awb-grid')); ?>",
                dataType : "json",
                data :  $("#form").serialize(),
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\GSA\gsa_final\resources\views/pages/report/awb.blade.php ENDPATH**/ ?>