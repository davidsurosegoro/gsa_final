  ...
  <div class="modal-dialog modal-xs">
    <div class="modal-content">
      ...
      <div class="modal-body row" > 
        <form class="col-12 bg-light" style="padding-bottom:10px;" id="forminvoice_" method="post" action="<?php echo e(url('master/invoice/updatestatus')); ?>">
...
$(document) .ajaxStart(function () {
    ...
    var dt = $('#datatables').DataTable({
	     ...
	     serverSide : false,
	     paging     : true,
	     ajax       :'<?php echo e(url('master/invoice/datatables')); ?>',
	     columns    : [
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\GSA\gsa_final\resources\views/pages/master/invoice/index.blade.php ENDPATH**/ ?>