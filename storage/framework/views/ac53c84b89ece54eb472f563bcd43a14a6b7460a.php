...
<html lang="en">
    ...
    <head><base href="">
        ...
        <style type="text/css">
            ...
            td.details-control {
    background: url('<?php echo e(asset("assets/img/icon/details_open.png")); ?>') no-repeat center center;
    cursor: pointer;
}
tr.details td.details-control {
    background: url('<?php echo e(asset("assets/img/icon/details_close.png")); ?>') no-repeat center center;
}
        ...
        <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
            ...
            <path d="M6,2 L18,2 C19.6568542,2 21,3.34314575 21,5 L21,19 C21,20.6568542 19.6568542,22 18,22 L6,22 C4.34314575,22 3,20.6568542 3,19 L3,5 C3,3.34314575 4.34314575,2 6,2 Z M12,11 C13.1045695,11 14,10.1045695 14,9 C14,7.8954305 13.1045695,7 12,7 C10.8954305,7 10,7.8954305 10,9 C10,10.1045695 10.8954305,11 12,11 Z M7.00036205,16.4995035 C6.98863236,16.6619875 7.26484009,17 7.4041679,17 C11.463736,17 14.5228466,17 16.5815,17 C16.9988413,17 17.0053266,16.6221713 16.9988413,16.5 C16.8360465,13.4332455 14.6506758,12 11.9907452,12 C9.36772908,12 7.21569918,13.5165724 7.00036205,16.4995035 Z" fill="#000000"/>
                                    ...
                                    <div class="topbar-item ml-2">
                                        <a class="btn btn-icon btn-outline-primary w-auto d-flex align-items-center px-2" href="<?php echo e(url('/')); ?>">
                                           <span class="symbol symbol-35">
                                        ...
                                        <div class="dropdown-menu p-0 m-0 dropdown-menu-right dropdown-menu-xl dropdown-menu-anim-up">
                                                <!--begin::Header-->
                                                <div class="d-flex align-items-center py-10 px-8 bgi-size-cover bgi-no-repeat rounded-top" style="background-image: url(<?php echo e(asset('assets/media/misc/bg-1.jpg')); ?>)">
                ...
                <div class="modal-body">
                    <form class="form" method="POST" action="<?php echo e(url('master/gantipassword')); ?>">  
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" required readonly class="form-control" style="background-color:#e4e4e4;" name="username" value="<?php echo e(Auth::user()->username); ?>" />        
                        </div>
                        <div class="form-group">
...
<?php endif; ?> 
    <!--end::Body-->
</html><?php /**PATH C:\xampp\htdocs\GSA\gsa_final\resources\views/layouts/app.blade.php ENDPATH**/ ?>