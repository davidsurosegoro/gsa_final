  ...
  <div class="card-body">
   ...
   <div class="col-lg-6">
    ...
    <div class="form-group">
     ...
     <div class="form-group">
      <label>harga Oa Shipment:</label>
       <input type="text" class="form-control rupiah" name="harga_oa_ship" placeholder="Input harga out area shipment. . ."/>
     </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\gsa_final\resources\views/pages/master/customer/create.blade.php ENDPATH**/ ?>