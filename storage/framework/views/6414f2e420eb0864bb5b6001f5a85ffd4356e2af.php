          ...
          <div class="form-group">
            ...
            <div class="row">
              <select name="kota" style="width: 100%" class="select2 form-control col-md-12" id="kota" data-live-search="true" required>
                ...
                <?php $__currentLoopData = $kota; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $u): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<div class="modal fade" id="modal-edit-agen" role="dialog"  aria-hidden="true">
  <div class="modal-dialog modal-lg" role="document">
    ...
    <form method="POST" action="<?php echo e(url('master/agen/update')); ?>">
...
<?php endif; ?>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\GSA\gsa_super_new\resources\views/pages/master/agen/index.blade.php ENDPATH**/ ?>