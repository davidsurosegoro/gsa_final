            ...
            <div class="row">
              ...
              <div class="col-lg-3">
                ...
                <select class="form-control select2" name="id_kota_tujuan" id="id_kota_tujuan">
                  <option value="-">--Tampil Semua--</option>
                  <?php $__currentLoopData = $kota; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $a): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
  ...
  $(document).ready(function() {
    ...
    $("#btnproses").on('click',function(){
        if($("#txtPeriod").val() != ''){
            $.ajax({
                type : "POST",
                url : "<?php echo e(url('report/manifest-grid')); ?>",
                dataType : "json",
                data :  $("#form").serialize(),
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\GSA\gsa_final\resources\views/pages/report/manifest.blade.php ENDPATH**/ ?>