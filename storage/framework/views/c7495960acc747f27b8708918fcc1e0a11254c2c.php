  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      ...
      <div class="modal-body row" >
        ...
        <form class="col-4 bg-light" id="formBooking" method="post" action="<?php echo e(url('master/kecamatan/save')); ?>">
...
<script type='text/javascript'>
    ...
    $("#simpanbutton").on('click',function(){  
        ...
        $.ajax({
            type      : "POST",
            url       : "<?php echo e(url('master/kecamatan/save')); ?>",
            dataType  : "json",
    ...
    function getlist(){
      ...
      $.ajax({
            type      : "GET",
            url       : '<?php echo e(url('master/kecamatan/datatables')); ?>',
            dataType  : "json",
            data : {
                id : id_kota_list || "",
            },
   ...
   function deleteCustomer(status,id,nama)
    ...
    function deletekecamatan( id,nama)
    {
        ...
        if (result.value) {
          $.ajax({
            method  :'POST',
            url     :'<?php echo e(url('master/kecamatan/delete')); ?>',
            data    :{
              id:id, 
              '_token': $('input[name=_token]').val()
            },
