   ...
   <div class="form-group">
     ...
     <div class="form-group">
      <label>harga_oa:</label>
       <input type="text" class="form-control rupiah"  name="harga_oa" placeholder="Input harga_oa. . ."/>
   ...
   <div class="col-lg-6">
    ...
    <div class="form-group">
      <label>harga_doc:</label>
       <input type="text" class="form-control rupiah" name="harga_doc" placeholder="Input harga_doc. . ."/>
      <span class="form-text text-muted">Silahkan input harga_doc</span>
     </div>

     <div class="form-group">
      <label>harga_oa_ship:</label>
       <input type="text" class="form-control rupiah" name="harga_oa_ship" placeholder="Input harga_oa_ship. . ."/>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\GSA\gsa_super_new\resources\views/pages/master/customer/create.blade.php ENDPATH**/ ?>