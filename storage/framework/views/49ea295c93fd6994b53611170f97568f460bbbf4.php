   ...
   function deleteCustomer(id,nama)
    {
         Swal.fire({   
            ...
            if (result.value) {
                $.ajax({
                            method:'POST',
                            url:'<?php echo e(url("master/customer/delete")); ?>',
                            data:{
                              id:id,
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\GSA\gsa_final\resources\views/pages/master/customer/index.blade.php ENDPATH**/ ?>