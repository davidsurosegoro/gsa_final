          ...
          <div class="row">
            <div class="col-xs-12 col-md-6 ">
              ...
              <div class="form-group">
                ...
                <input type="number" name="presentase" id="presentase1" class="form-control form-control-solid" placeholder="Input Presentase Bagi Hasil. . ." required>
              </div>
              <div class="form-group">
                <label>Presentase as Pengirim (transit sub)  :</label>
                <input type="number" name="presentasetransit" id="presentasetransit" class="form-control form-control-solid" placeholder="Input Presentase Transit sebagai pengirim. . ." required>
              </div>
            </div>
            <div class="col-xs-12 col-md-6 "> 
              <div class="form-group">
                ...
                <select class="form-control  form-control-solid form-select" name="has_harga_khusus" id="has_harga_khusus" aria-label="Default select example">
              ...
              <div class="form-group">
                ...
                <input type="number" name="harga_doc" id="harga_doc" class="form-control form-control-solid" placeholder="harga_doc" >
              </div>
              <div class="form-group">
                <label>harga kg(untuk 5 kg pertama)</label>
                <input type="number" name="harga_kg" id="harga_kg" class="form-control form-control-solid" placeholder="harga_kg" >
              </div>
              <div class="form-group">
                <label>harga kg selanjutnya</label>
                <input type="number" name="harga_kg_selanjutnya" id="harga_kg_selanjutnya" class="form-control form-control-solid" placeholder="harga_kg_selanjutnya" >
              </div>
              <div class="form-group">
                <label>harga koli kecil</label>
                <input type="number" name="harga_koli_k" id="harga_koli_k" class="form-control form-control-solid" placeholder="harga_koli_k" >
              </div>
              <div class="form-group">
                <label>harga koli sedang</label>
                <input type="number" name="harga_koli_s" id="harga_koli_s" class="form-control form-control-solid" placeholder="harga_koli_s" >
              </div>
              <div class="form-group">
                <label>harga koli besar</label>
                <input type="number" name="harga_koli_b" id="harga_koli_b" class="form-control form-control-solid" placeholder="harga_koli_b" >
              </div>
              <div class="form-group">
                <label>harga koli besar banget</label>
                <input type="number" name="harga_koli_bb" id="harga_koli_bb" class="form-control form-control-solid" placeholder="harga_koli_bb" >
              </div>
            </div>
          </div>
