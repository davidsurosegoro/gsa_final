            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    @if (!Browser::isChrome() ) 
                        ...
                        border-color: #ffeeba;">
                            <img src="{{asset('assets/gsa/img/chrome.png')}}" class="col-2" style="object-fit: contain;">
                            <div class="col-10">
    ...
    <div class="modal fade" id="modalreport" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">  
                    <a  href="{{ url('report/awb') }}"  class="btn btn-primary btn-lg btn-block"><i class="fa fa-truck" aria-hidden="true"></i>&nbsp;Halaman Report AWB</a> 
                    <a  href="{{ url('report/manifest') }}" class="btn btn-primary btn-lg btn-block"><i class="fa fa-file-text-o" aria-hidden="true"></i> &nbsp;Halaman Report Manifest</a> 
                    <a  href="{{ url('report/invoice') }}" class="btn btn-primary btn-lg btn-block"><i class="fa fa-usd" aria-hidden="true"></i> &nbsp;Halaman Report Invoice</a> 
                    <a  href="{{ url('report/bonus') }}" class="btn btn-primary btn-lg btn-block"><i class="fas fa-gifts" aria-hidden="true"></i> &nbsp;Halaman Report Bonus</a> 
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button> 
                </div>
